...
export default function(router: express.Router) {
  ...
  router.put('/books/:id', ExpressRouterAdapter.adapt(UpdateBookRouterFactory.make()))
  router.get('/books', ExpressRouterAdapter.adapt(ReadBooksRouterFactory.make()))
  router.get('/books/:id', ExpressRouterAdapter.adapt(ReadBookRouterFactory.make()))
  router.delete('/books/:id', ExpressRouterAdapter.adapt(DeleteBookRouterFactory.make()))
}