...
export default class CreateUserUseCase implements ICreateUserUseCase{
  ...
  async create (createUserUseCaseParam: ICreateUserUseCaseParam): Promise<User | null>{
    ...
    const hashedPassword = await this.encrypter.hash(createUserUseCaseParam.password)
    let user: User | null = {
