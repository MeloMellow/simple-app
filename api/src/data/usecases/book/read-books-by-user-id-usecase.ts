...
export default class ReadBooksByUserIdUseCase
  implements IReadBooksByUserIdUseCase
{
  constructor(
    private readonly readBooksByUserIdRepository: IReadBooksByUserIdRepository
  ) {}
